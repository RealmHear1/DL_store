...
const ProductCard = ({price, title, rating, thumbnail, discountPercentage}: ProductData) => {

  return (
    <div className={classes.product__card}>
      <a href="/" target='_blank' className={`${classes['product__card-image']}`}>
        <img src={`${thumbnail}`} className={`${classes['product__card-image']}`}/>
      </a>
